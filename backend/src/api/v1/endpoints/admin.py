...
from src.dependencies import get_admin_service, get_settings, require_admin_access, verify_owner_access
...
) -> APIResponse[AdminMetricsResponse]:
...
async def feedback(
    ...
    verify_owner_access(raw_request, request.owner_id)
    try:
